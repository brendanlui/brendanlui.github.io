...
while($row = mysqli_fetch_array($result))
{
	if(strcmp($row['caller'], $_SESSION['username']) == 0){
		if(strcmp($row['resolved'],'Resolved') == 0){
			echo '				
							...
							<tr>
								<td>
									<div class="detail">
										...
										<div class="receiver">Caller: '.$row['caller'].'</div>
										<div class="caller" id="resolved">Receiver: '.$row['user_do_this_job'].'</div>
							...
							<tr>
								<td>
									<div class="detail">
										...
										<div class="receiver">Caller: '.$row['caller'].'</div>
										<div class="caller" id="available">Receiver: '.$row['user_do_this_job'].'</div>
