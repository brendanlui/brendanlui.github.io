...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    }else if(ctype_digit($_POST['username'])){
		$username_err = 'Username must not only consist of digits.';
	}else{
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT username, password FROM database_admins WHERE username = ?";
                   ...
                   mysqli_stmt_bind_result($stmt, $username, $hashed_password);
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            header("location: admin_print_all_new_notice_detail.php");
                        } else{
...
<body>
	...
	<div class="first_words">Here you see anything!</div>
